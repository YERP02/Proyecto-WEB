<?php 
    ...
    if (isset($_POST['Actualizar'])) {
        ...
        WHERE id = ', NEW.id)";
        $queryBuscar = "UPDATE producto SET WHERE nombre LIKE '%$nombreTenis%'";
        $resultBuscar = mysqli_query($con, $queryBuscar);
                ...
                if($Enc === 0){
                   echo '<input type="text" name="nombreBusqueda" id="nombreBusqueda" placeholder="Nombre del Producto a Buscar" >' ;
                    ...
                    if (isset($productoEncontrado)) {
                        echo "<input type=$text name='NombreT' value= '$nombreT' readonly>";
                        echo "<input type=$text name='idT' value='$ID' readonly>";
                        echo "<input type=$text name='Tallas' value= '$tallas' readonly>";
                        echo "<input type=$text name='Modelo' value= '$modelo' readonly>";
                        echo "<input type='number' name='Precio' value= '$precio' readonly>";
                        echo "<input type=$text name='Colores' value= '$colores' readonly>";
                        echo "<input type=$text name='imagen' value= '$imagen' readonly>";
                        echo "<input type=$text name='detalles' value= '$detalles' readonly>";
                    }
                }
                ?>
